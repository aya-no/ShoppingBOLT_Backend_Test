...
export default function ShoppingListCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ShoppingList(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ShoppingListCreateForm")}
      {...rest}
    >
      <TextField
        label="Date"
