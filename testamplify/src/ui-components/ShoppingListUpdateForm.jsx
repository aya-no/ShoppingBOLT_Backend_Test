...
export default function ShoppingListUpdateForm(props) {
  const {
    id: idProp,
    shoppingList: shoppingListModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const [shoppingListRecord, setShoppingListRecord] = React.useState(
    shoppingListModelProp
  );
  React.useEffect(() => {
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || shoppingListModelProp)}
